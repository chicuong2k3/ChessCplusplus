...
Rook::Rook(Vec2<int> position, bool isWhite, int owner, bool isAlive) : Piece(position, isWhite, owner, isAlive)
{
}

std::vector<Move*> Rook::generatePossibleMoves(Board* board)
{
